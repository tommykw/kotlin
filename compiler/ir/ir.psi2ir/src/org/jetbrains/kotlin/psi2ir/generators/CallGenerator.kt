        ...
        return when (descriptor) {
            ...
            is FunctionDescriptor ->
                ...
                call.callReceiver.call { _, _ ->
                    generateExpressionForReferencedDescriptor(startOffset, endOffset, descriptor, call.original, origin)
                    ?: TODO("Unexpected callable descriptor: $descriptor ${descriptor.javaClass.simpleName}")
                }
        }
    }

    fun generateExpressionForReferencedDescriptor(
            startOffset: Int,
            endOffset: Int,
            ...
            when (descriptor) {
                is FakeCallableDescriptorForObject ->
                    generateExpressionForReferencedDescriptor(startOffset, endOffset, descriptor.getReferencedDescriptor(), resolvedCall, origin)
                is TypeAliasDescriptor ->
                    generateExpressionForReferencedDescriptor(startOffset, endOffset, descriptor.classDescriptor!!, null, origin)
                is ClassDescriptor -> {
